...
export const blockDefinitions: readonly BlockDefinition[] = [
  { id: BLOCK.grass, name: "Grass", solid: true, opaque: true, buildable: true, top: [0.49, 0.65, 0.31], side: [0.43, 0.48, 0.29], bottom: [0.43, 0.34, 0.23], icon: ["#9daf79", "#789963", "#5d7b4d"] },
  { id: BLOCK.sand, name: "Sand", solid: true, opaque: true, buildable: true, top: [0.87, 0.80, 0.59], side: [0.78, 0.69, 0.47], icon: ["#f0dba4", "#d4b87c", "#b59a62"] },
  { id: BLOCK.rock, name: "Rock", solid: true, opaque: true, buildable: true, top: [0.64, 0.66, 0.62], side: [0.53, 0.57, 0.56], icon: ["#a5afb0", "#7d898b", "#626e72"] },
  { id: BLOCK.gravel, name: "Gravel", solid: true, opaque: true, buildable: true, top: [0.70, 0.68, 0.61], side: [0.61, 0.59, 0.52], icon: ["#c6bfb0", "#a39d8e", "#888577"] },
  ...
  { id: BLOCK.soil, name: "Soil", solid: true, opaque: true, top: [0.48, 0.39, 0.27], side: [0.46, 0.37, 0.25], icon: ["#988266", "#7c6247", "#665039"] },
