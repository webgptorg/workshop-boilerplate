...
export default function Home() {
  ...
  async function endCall() {
    ...
    try {
      ...
      // The completed call is driven by the summary returned for this
      // transcript. Scenario actions are only the offline fallback while the
      // summary request is unavailable.
